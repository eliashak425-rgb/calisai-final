...
CREATE TABLE "WorkoutLog" (
    ...
    CONSTRAINT "WorkoutLog_dayId_fkey" FOREIGN KEY ("dayId") REFERENCES "WorkoutDay" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "TemplatePlan_fitnessLevel_goalFocus_idx" ON "TemplatePlan"("fitnessLevel", "goalFocus");
